...
function radialBarChart() {
  ...
  function init(d) {
    // Utilise d3.scaleLinear() pour D3 v7
  ...
  function initChart(container) {
    ...
    // Cercles concentriques aux tick values spécifiés
    g.append('g')
  ...
  function renderOverlays(container) {
    ...
    g.append('g')
      .classed('axis', true)
      .call(axis)
      .style('color', 'white'); // Change la couleur de l'axe en blanc
  ...
  function chart(selection) {
    selection.each(function(d) {
      ...
      var segmentsEnter = segments.enter()
      .append('path')
